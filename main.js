...
Snake.prototype.generateFood = function(itemsRemain) {
    var x = Math.ceil(Math.random() * this.options.field.sizeX - 1) - 1,
        y = Math.ceil(Math.random() * this.options.field.sizeY - 1) - 1;
...
Snake.prototype.die = function() {
    ...
    for(var i = 0, len = this.food.length; i < len; i++) {
        setTimeout(function(){
            var foodItem = _this.food.shift();
            foodItem.element.className = 'snake__food snake__food_die';
        }, i * 200);
    }
}
